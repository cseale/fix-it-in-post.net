...
class ConvolutionalDeep_Time(BaseModel):
    def __init__(self, n_features, n_segments):
        super(ConvolutionalDeep_Time, self).__init__()
        self.n_features = n_features
        self.n_segments = n_segments
        self.conv1 = nn.Conv2d(1, 70, kernel_size=(9, 5), padding=(4, 2))

        self.conv2 = nn.Conv2d(70, 50, kernel_size=(9, 5), padding=(4, 2))
        self.conv3 = nn.Conv2d(50, 20, kernel_size=(9, 5), padding=(4, 2))
        self.conv4 = nn.Conv2d(20, 70, kernel_size=(9, 5), padding=(4, 2))

        self.conv5 = nn.Conv2d(70, 50, kernel_size=(9, 5), padding=(4, 2))
        self.conv6 = nn.Conv2d(50, 20, kernel_size=(9, 5), padding=(4, 2))
        self.conv7 = nn.Conv2d(20, 70, kernel_size=(9, 5), padding=(4, 2))

        self.conv8 = nn.Conv2d(70, 50, kernel_size=(9, 5), padding=(4, 2))
        self.conv9 = nn.Conv2d(50, 20, kernel_size=(9, 5), padding=(4, 2))
        self.conv10 = nn.Conv2d(20, 70, kernel_size=(9, 5), padding=(4, 2))

        self.conv11 = nn.Conv2d(70, 50, kernel_size=(9, 5), padding=(4, 0))
        self.conv12 = nn.Conv2d(50, 20, kernel_size=(9, 3), padding=(4, 0))
        self.conv13 = nn.Conv2d(20, 70, kernel_size=(9, 2), padding=(4, 0))
