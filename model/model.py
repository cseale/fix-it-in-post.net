...
class ConvolutionalBaseline(BaseModel):
    def __init__(self, n_features, n_segments):
        ...
        self.conv1 = nn.Conv2d(1, 18, kernel_size=(9,8), stride=1, padding=(4, 0))
        self.conv1_bn = nn.BatchNorm2d(18)
        self.conv2 = nn.Conv2d(18, 30, kernel_size=(9,8), stride=1, padding=(4, 0))
        self.conv2_bn = nn.BatchNorm2d(30)
        self.conv3 = nn.Conv2d(30, 40, kernel_size=(9,8), stride=1, padding=(4, 0))
    ...
    def forward(self, x):
        ...
        x = x.view(-1, 40 * self.n_features * self.n_segments)
        x = F.relu(self.fc1_bn(self.fc1(x)))
        x = self.fc2(x)
        return x